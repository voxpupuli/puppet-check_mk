...
EOS
    it {
      is_expected.to contain_file('/dir/TEST_HOSTGROUP.cfg').with(ensure: 'present',
...
EOS
    it {
      is_expected.to contain_file('/dir/TEST_HOUSTGROUP_WITH_UNDERSCORES.cfg').with(ensure: 'present',
                                                                                    content: expected_file_content)
    }
  end
end
